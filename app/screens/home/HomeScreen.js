    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView style={styles.buttons}>
                <View style={styles.mainMenuBlock}>
                    ...
                    >
                        ...
                        <Text style={styles.buttonTitle}>{i18n.t('objects')}</Text>
                    </Pressable>
                    <Pressable
                        style={({pressed}) => [
                            {
                    ...
                    >
                        ...
                        <Text style={styles.buttonTitle}>{i18n.t('geozones')}</Text>
                    </Pressable>
                </View>
                <View style={styles.mainMenuBlock}>
                    <Pressable
                    ...
                    >
                        ...
                        <Text style={styles.buttonTitle}>{i18n.t('drivers')}</Text>
                    </Pressable>
                    <Pressable
                        style={({pressed}) => [
                            {
                    ...
                    >
                        ...
                        <Text style={styles.buttonTitle}>{i18n.t('map')}</Text>
                    </Pressable>
                </View>
                <View style={styles.mainMenuBlock}>
                    <Pressable
                    ...
                    >
                        ...
                        <Text style={styles.buttonTitle}>{i18n.t('events')}</Text>
                    </Pressable>
                    <Pressable
                        style={({pressed}) => [
                            {
                    ...
                    >
                        ...
                        <Text style={styles.buttonTitle}>{i18n.t('gas')}</Text>
                    </Pressable>
                </View>
                <View style={styles.mainMenuBlock}>
                    <Pressable
                    ...
                    >
                        ...
                        <Text style={styles.buttonTitle}>{i18n.t('services')}</Text>
                    </Pressable>
                    <Pressable
                        style={({pressed}) => [
                            {
                    ...
                    >
                        ...
                        <Text style={styles.buttonTitle}>{i18n.t('settings')}</Text>
                    </Pressable>
                </View>
            </ScrollView>
            <Pressable
            ...
            >
                ...
                <Text style={{marginLeft: 10}}>{i18n.t('home_footer')}</Text>
            </Pressable>
        </SafeAreaView>
    );
};
