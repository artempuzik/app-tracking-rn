        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView style={styles.textContainer}>
                ...
                <View style={styles.checkboxContainer}>
                    ...
                    />
                    <Text style={styles.label}>Время, дни</Text>
                </View>
                <View style={styles.checkboxContainer}>
                    <Checkbox
                        color='#2060ae'
                        ...
                        style={styles.checkbox}
                    />
                    <Text style={styles.label}>Одометр, км</Text>
                </View>
                <View style={styles.checkboxContainer}>
                    <Checkbox
                        color='#2060ae'
                        ...
                        style={styles.checkbox}
                    />
                    <Text style={styles.label}>Время работы, ч</Text>
                </View>
            </ScrollView>
            <View style={{paddingHorizontal: 20}}>
                <Button title={'Применить'} onPress={() => {}} />
            </View>
        </SafeAreaView>
    );
};

export default ObjectTaskScreen;
